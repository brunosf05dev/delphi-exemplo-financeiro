...
begin
  ...
  begin
    Application.MessageBox(PChar('Usuário "' + EdtLogin.Text + '" não esta cadastrado ou senha inválida. Tente novamente.'), 'Login ou senha inválidos', MB_ICONEXCLAMATION);
...
begin
  ...
  try
    ...
    showmessage('Banco não configurado corretamente! Verifique os parâmetros de configuração');
    exit;
  end;
end;
