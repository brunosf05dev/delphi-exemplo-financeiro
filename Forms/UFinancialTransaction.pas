...
begin
  if EdtTransactionValue.Text = '0' then
  begin
    ShowMessage('Insira um valor maior que zero');
    Exit;
  end;
...
procedure TFFinancialTransaction.GDataDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer;
  Column: TColumn; State: TGridDrawState);
begin
  if DM.SQLFinancialTransaction.Active = False then
    Exit;
